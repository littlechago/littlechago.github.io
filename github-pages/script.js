...
const adLandingPage = "ad-landing.html";
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function moveQR() {
        ...
        const maxX = window.innerWidth - containerWidth; // Account for QR container width

        // Reserve bottom area for taskbar/dock (typically 40-60px)
        const taskbarReserve = 60;
        const maxY = window.innerHeight - containerHeight - taskbarReserve;

        // Set minimum Y to avoid placing too high
        ...
        // Ensure we're within safe boundaries
